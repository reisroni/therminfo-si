...
$item_1 = '<a href="administration/admin_main" title="Back to main area"><i class="icon-arrow-left-3 fg-darker on-left"></i></a>Backoffice: <small>Insert New Compounds/Values</small>';
$item_2 = '<a class="element" href="administration/admin_main" title="Main area">Main</a>';
$data = array(
		'title' => $item_1,
        'menu_items' => $item_2,
        'logout_url' => 'administration/admin_insert_data',
		'css_files' => array('public/css/pages/admin.css'),
		'js_files' => array('public/js/vendor/plugins/jquery.ocupload.min.js','public/js/admin_add.js'));
...
<div id="a-add-form" class="center">
	<form id="a-insert-form" enctype="multipart/form-data" action="<?php echo site_url('administration/admin_insert_data/insert_new_data_values');?>" method="post">
		...
		<div id="a-add-pane-group">
			<div class="a-add-pane-1">
				<fieldset>
					...
					<span> or </span>
					<a id="add-ref-bt" href="administration/admin_insert_data#add-ref" title="Add a new Reference to the database" >Add Reference</a>
				</fieldset>
			</div>
			<div class="a-add-pane-1">
				<fieldset>
	...
	<div id="add-ref" title="Add New Reference">
		<form id="a-insert-ref-form" action="<?php echo site_url('administration/admin_insert_data/insert_new_reference');?>" method="post">
			<fieldset>
				...
				<ul>
					<li class="textCenter">
						...
						<span> or </span>
						<a id="add-auth-bt" href="administration/admin_insert_data#add-author" title="Add New Author" >Add Author</a>
					</li>
				</ul>
			</fieldset>
			<fieldset>
	...
	<div id="add-author" title="Add New Author">
		<form id="a-insert-auth-form" action="<?php echo site_url('administration/admin_insert_data/insert_new_author');?>" method="post">
